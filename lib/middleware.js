...
var instrumenterLib = require('./instrumenter');
  ...
  return function(req, res, next) {
    ...
    if ( process ) {
      ...
      if (absolutePath.match(/\.htm(l)?$/)) {
        ...
        console.log('kjdsksks', html.replace('coverage = global[gcv] || (global[gcv] = {});', `coverage = global.WCT.share.__coverage__ || (global.WCT = { share: { __coverage__: {} } }); `));
